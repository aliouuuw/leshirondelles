              ...
              <div className="space-y-6">
                ...
                <div className="max-w-xl">
                  <p className="text-xl text-gray-600 leading-relaxed mb-6">
                    ...
                    environnement stimulant qui développe l&apos;esprit critique,
                    l&apos;autonomie et l&apos;ambition de nos futurs leaders.
                  </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      ...
                      d&apos;Études Moyennes avec un accompagnement personnalisé pour
                      chaque élève.
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-100 mb-8 leading-relaxed">
              Offrez à votre adolescent une formation collégiale d&apos;exception qui
              le préparera aux défis du lycée et aux études supérieures.
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <a href="/contact" className="btn btn-accent">
                Planifier une Visite
              </a>
              <a href="/admissions" className="font-family-poppins font-medium text-[0.875rem] px-[2rem] py-[1rem] tracking-[0.025em] text-white border-1 border-white hover:underline transition-all duration-300 translate-y-0 hover:translate-y-[-1px]">
