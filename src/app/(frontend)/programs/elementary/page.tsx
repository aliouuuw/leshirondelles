...
const classLevels = [
  {
    ...
    image: "/images/programs/elementary-cp.jpg",
  ...
  },
  {
    ...
    image: "/images/programs/elementary-ce.jpg",
  ...
  },
  {
    ...
    image: "/images/programs/elementary-cm.jpg",
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-6">
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  <span className="block text-gray-900">Élémentaire</span>
                  <span className="block text-primary">6-11 ans</span>
                </h1>

                <div className="max-w-xl">
                  <p className="text-xl text-gray-600 leading-relaxed mb-6">
                    Des fondations solides pour l&apos;apprentissage académique avec
                    un programme riche qui développe la curiosité intellectuelle
                    et l&apos;autonomie de chaque élève.
                  </p>
              ...
              <div className="relative">
                <div className="relative h-[500px] w-full">
                  <Image
                    ...
                    alt="Élémentaire Les Hirondelles"
                    fill
        ...
        <div className="container mx-auto px-6 max-w-6xl text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-100 mb-8 leading-relaxed">
              Offrez à votre enfant une éducation élémentaire d&apos;excellence qui
